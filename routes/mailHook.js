            ...
            newBox.save(function(err, data) {
              ...
              */
              for (var i = 0; i < parsedEmails.length; i++) {
                ...
                mailOptions.html = userName + ' has started a new conversation with you.<b>To view this conversation, <a href="' + flyboxURL + '">Click here</a></b><br><br><center>This email sent with <img src="http://www.flybox.io/logo/flybox.png" width="150px" height="53px"> ';
